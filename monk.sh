...
if [[ ${OPTION} == "1" ]] ; then
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_list.sh -O monk_list.sh > /dev/null 2>&1
  ...
  read ALIAS
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_check_sync.sh -O monk_check_sync.sh > /dev/null 2>&1
  ...
  read ALIAS
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_check_resync_all.sh -O monk_check_resync_all.sh > /dev/null 2>&1
  ...
  read ALIAS
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_restart.sh -O monk_restart.sh > /dev/null 2>&1
  ...
  read ALIAS
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_stop.sh -O monk_stop.sh > /dev/null 2>&1
  chmod 777 monk_stop.sh  
  dos2unix monk_stop.sh > /dev/null 2>&1
  /bin/bash ./monk_stop.sh $ALIAS
elif [[ ${OPTION} == "6" ]] ; then
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_setupv2.sh -O monk_setupv2.sh > /dev/null 2>&1
  ...
  read ALIAS
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_check_status.sh -O monk_check_status.sh > /dev/null 2>&1
  ...
  read ALIAS
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monk_resync.sh -O monk_resync.sh > /dev/null 2>&1
  chmod 777 monk_resync.sh
  dos2unix monk_resync.sh > /dev/null 2>&1
  /bin/bash ./monk_resync.sh $ALIAS
elif [[ ${OPTION} == "9" ]] ; then  
  wget https://raw.githubusercontent.com/Grimer123/MonkeyProjectScripts/master/monkey_logo.sh -O monkey_logo.sh > /dev/null 2>&1
